...
a.w):(d.attr("width",f.w).attr("height",f.h),g=!1)}else{if(d.attr("width")&&(e=a.h/d.height(),b=b?2:1.15,1<=e&&e<b||1>e&&e>1/b&&d.width()<c.w))return;d.attr("width",a.w).attr("height",a.h).attr("src",a.url).attr("usemap","#map"+a.type)}g&&($("#derivativeSwitchBox .switchCheck").css("visibility","hidden"),$("#derivativeChecked"+a.type).css("visibility","visible"));d.off('load').on('load',function(){const attrW = $(this).attr('width');const attrH = $(this).attr('height');$(this).css({'width':attrW?attrW:'auto','height':attrH?attrH:'auto'});});}}
